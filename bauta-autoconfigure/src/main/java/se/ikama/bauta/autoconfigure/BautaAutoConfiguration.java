...
@ComponentScan(basePackages = {"se.ikama.bauta.autoconfigure","se.ikama.bauta.config","se.ikama.bauta.core.metadata","se.ikama.bauta.core.dao","se.ikama.bauta.cli","se.ikama.bauta.ui","se.ikama.bauta.rest","se.ikama.bauta.scheduling"})
