...
@ImportResource({
        ...
        "file://${batchc3.jobBeansDir}/*.xml"
})
@EnableBatchProcessing(modular = true)
@EnableVaadin("ikama.batchc3.ui")
public class BatchConfiguration {
    ...
    public BatchConfigurer batchConfigurer() {
        log.info("Creating C3 batch configurer.");
        BatchConfigurer batchConfigurer = new DefaultBatchConfigurer(batchDataSource()) {
